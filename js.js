$(document).ready(function () {
    var projects = [
        {
            title: "Rival  plateform",
            image: "images/Rival.jpg",
            link: "https://rival-dz.com/",
            desc: " Online learning platform developed with Tutor LMS theme of WordPress, Woocommerce, Elementor, PHP and JavaScript.",
            tchlgs: ["wordpress", "woocommerce", "php", "java-script"],
        },
        {
            title: "odorant website",
            image: "images/odorant.jpg",
            link: "https://odorant-parfums.netlify.app/",
            desc: "An ecommerce website meticulously crafted to offer an unparalleled shopping experience for perfume enthusiasts, featuring seamless communication and a responsive, user-friendly interface.",
            tchlgs: ["vueJS", "tailwind", "emailJs", "html2pdf"],
        },
        {
            title: "EarthMeta",
        ...
        {
            title: "Bitcoin front website",
            image: "images/bitcoin.png",
            link: "https://bitcoin-agency.netlify.app/",
            desc: " A simple front end project with well designed pages using HTML and CSS , i made that for a client in fiverr ",
            tchlgs: ["html","css"],
        },
